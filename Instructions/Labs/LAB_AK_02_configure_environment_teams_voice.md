...
> [!IMPORTANT]
> **Known Issue with Version 1.6.0.0**: Version 1.6.0.0 of the Microsoft Teams Network Assessment Tool (released October 21, 2025) is known to cause memory corruption errors on virtual machines. If you encounter errors such as "System.AccessViolationException: Attempted to read or write protected memory", this is a known issue with version 1.6.0.0.
>
> **Recommended Action**: If version 1.6.0.0 is the only version available on the Microsoft Download Center, please skip Exercise 2 (Use the Teams Network Assessment Tool) and proceed to Exercise 3. The network assessment functionality is important for production deployments, but for lab purposes, you can continue with the remaining exercises without completing the network assessment tasks.
>
> Microsoft is aware of this issue and a fix is expected in a future update. For production environments, please use version 1.5.0.0 or wait for version 1.6.1 or later which should resolve this issue.
...
> [!NOTE]
> If you encountered issues with version 1.6.0.0 during Task 1, or if you're experiencing memory corruption errors when running the tool, please skip this task and the remaining tasks in Exercise 2 (Tasks 3, 4, and 5). Proceed directly to Exercise 3: Configure a basic network topology for dynamic emergency calling.
